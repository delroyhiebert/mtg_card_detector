...
class Config:
    ...
    #Currently only using a subset of sets during dev

    # Core & expansion sets with 2003 frame
    set_2003_list = ['mrd', 'dst', '5dn', 'chk', 'bok', 'sok', 'rav', 'gpt', 'dis',
                     #'csp',
                     #'tsp',
                     'plc', 'fut', '10e',
                     'lrw', 'mor', 'shm', 'eve', 'ala', #'con',
                     'arb', 'm10', 'zen', 'wwk', 'roe', 'm11',
                     #'som', 'mbs',
                     'nph',
                     # 'm12', 'isd', 'dka', 'avr', 'm13',
                     'rtr']#, 'gtc', 'dgm', 'm14', 'ths', 'bng', 'jou']
    ...
    card_mask_path = Path.cwd() / 'data' / 'mask.png'
